...
<div class="max-w-4xl mx-auto px-4 py-10">
    <div class="flex items-center justify-between mb-6 gap-4">
        ...
        <a href="{{ route('agent.notifications.index') }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-700 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 transition">

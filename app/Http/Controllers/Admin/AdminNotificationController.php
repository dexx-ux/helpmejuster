...
class AdminNotificationController extends Controller
{
    ...
    public function show(Request $request, DatabaseNotification $notification)
    {
        ...
        if ($applicationId) {
            // Add similar existence check for applications if needed
    ...
    public function markAsRead(Request $request, DatabaseNotification $notification)
    {
        ...
        if (!$isDeleted) {
            ...
            if ($ticketId) {
                $ticket = Ticket::find($ticketId);
                if ($ticket) {
                    $redirectUrl = route('admin.tickets.show', $ticketId);
                } else {
                    // Ticket doesn't exist, mark as deleted
                    $isDeleted = true;
                }
            } elseif ($applicationId) {
                $redirectUrl = route('admin.applications.show', $applicationId);
            }
        }
        ...
        return response()->json([
            ...
            'notification_url' => route('admin.notifications.show', $notification->id)
        ]);
    }

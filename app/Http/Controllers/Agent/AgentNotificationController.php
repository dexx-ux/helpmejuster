...
class AgentNotificationController extends Controller
{
    ...
    public function show(Request $request, DatabaseNotification $notification)
    {
        ...
        if ($isDeleted) {
            return view('agent.notifications.show', [
    ...
    public function markAsRead(Request $request, DatabaseNotification $notification)
    {
        ...
        if (!$isDeleted) {
            ...
            if ($ticketId) {
                $ticket = Ticket::find($ticketId);
                if ($ticket) {
                    $redirectUrl = route('agent.tickets.show', $ticketId);
                } else {
        ...
        return response()->json([
            ...
            'notification_url' => route('agent.notifications.show', $notification->id)
        ]);
    }
...
>>>>>>> b0c0e2c971a5c46df7f3dd5eab2ca3a7e70516f3
    ...
    public function markAllRead(Request $request)
    {
        ...
        return redirect()->route('agent.notifications.index')->with('success', 'All notifications marked as read.');
    }
    ...
    public function deleteAll(Request $request)
    {
        ...
        return redirect()->route('agent.notifications.index')->with('success', 'All read notifications cleared.');
    }
}